    ...
    <div className=" About-content">
      ...
      <div className="row2">
        <div className="row2-quote text-center ">
          <blockquote>
            Bothered by Alcohol's contribution to the Global burden of diseases,
            <br />
            the birth of NAKWA ARMS was inspired when founder Eric Nana Ntiamoah{" "}
            <br /> a Natural Medicine Reseacher and Co-founder Kwaku Adu Baah
            another organic freak <br /> dicovered a new way humans can improve
            their health with pleasure , <br />
            through the exploitation of the Noni plant and other medicinal
            crops, Supported by
            <br />
            Evidence-based, High-impact Policy measures that promotes Well-being
            and Social progress.
          </blockquote>
          <hr className="hr-1" />
        </div>
          ...
          <MDBRow>
            ...
            <MDBCol md="6">
              <div className="row3-text">
                ...
                <p>
                  After years of persistent research and experiments, a special
                  type of alcohol generated from Noni fruit was discovered. This
                  medicinal alcohol together with other discoveries like natural
                  honey-jell produced by a plant called 'Samanea' and other
                  medicinal flavours like 'hibiscus' and ‘Aidan fruit ’ which
                  substitutes high chemical flavours and sweeteners used by most
                  producers, that has negative effect on human health.
                  <br />
                  <br />
                  All these medicinal ingredients have been brought together to
                  form 100% Organic and Chimical-free products which is focused
                  on allowing consumers to not only Enjoy Pleasure but improve
                  and maintain Good Health. We want to build a community of
                  Health-focused Consumers through Noni. Hence our value
                  proposition is to sell the benefit of Pleasure and Good health
                  to Consumers.
                </p>
              </div>
            </MDBCol>
      ...
      <div className="row4 text-center">
        <div className="row4-content">
          ...
          <blockquote className="text-center quote">
            ...
            over 900 million in Africa and 7.6million in Ghana recorded by (WHO)
      ...
      <div className="row5 container">
        <div className="row5-content text-center">
          <h1
          // className="fadeInUp undefined"
          // style={"visibility: visible; animation-name: fadeInUp;"}
          >
            {" "}
            Nothing Matters More Than You , <br /> Health First !
          </h1>
          <p className="p1">
            ...
            to consumers. So all our decision are guided by strong core values.
          </p>
          <MDBRow className="first-row ">
            <MDBCol md="6" className="text-left">
              ...
              <p>
                ...
                Health-Focused, Thus our products are strictly 100% Organic from
                farming, processing and production to make sure it is
              ...
              {/* <video
                className="video-fluid z-depth-1 col2-img "
                autoPlay
                loop
                muted
              >
                <source src="images/house noni.mp4" type="video/mp4" />
              </video> */}
            </MDBCol>
            <MDBCol md="6" className="text-right">
              ...
              <p>
                ...
                equal and unlimited services. 1% of each product bought is used
                to support the SignAfrika Project to promote Sign Language and
                Deaf Employment in Ghana aimed at breaking the barrier between
                the Deaf and hearing to promote Accessibility and Equality at
                work, homes and social gatherings in Africa.{" "}
              </p>
              <img
                className="img-fluid col2-img z-depth-3 "
            ...
            <MDBCol md="10" className="text-center">
              ...
              {/* <img className="img-fluid col2-img" src="./images/port.jpg"></img> */}
              <video
                className="video-fluid z-depth-3 col2-vid "
                autoPlay
                loop
                muted
              >
